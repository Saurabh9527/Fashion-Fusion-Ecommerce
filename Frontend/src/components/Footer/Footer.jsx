...
const Footer = () => {
  ...
  const scrollOnTop  = () => {
    // TODO when click on icon scroll on top
  }
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<span className="self-center text-3xl font-semibold ">FASHION FUSION</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">Men</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Women</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Watches</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Shoes</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<a rel="noopener noreferrer" href="#">Shipping and Returns</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
